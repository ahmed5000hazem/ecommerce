...
@section('content')
    ...
    <div class="container my-5 pt-3 pb-5">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="/seller/discounts/items-items-disc/{{$discount->id}}/delete" method="post">
                            @csrf
        ...
        <form action="/seller/discount/items-items-disc/{{$discount->id}}/update" method="post">
            @csrf
