...
@section('content')
    ...
    <div class="container my-5 pt-3 pb-5">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="/seller/discounts/items-value-disc/{{$discount->id}}/delete" method="post">
                            @csrf
        ...
        <form action="/seller/discount/items-value-disc/{{$discount->id}}/update" method="post">
            @csrf
                        ...
                        <div class="col">
                            <div class="card mt-5" style="">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="/seller/product/{{$product->id}}" class="btn mt-4 btn-primary">{{__("app.details")}}</a>
                ...
                <div class="col-md-8">
                    ...
                    <div class="my-5">
                        ...
                        <div class="row row-cols-2">
                            <div class="col mt-4">
                                <input type="text" class="form-control" name="items_value_disc_items_number" value="{{$discount->items_count}}" placeholder="{{__("app.prod-number")}}">
                            </div>
                            <div class="col mt-4">
                                <input type="text" class="form-control" name="items_value_disc_value" value="{{$discount->items_value}}" placeholder="{{__("app.value")}}">
                            </div>
                            <div class="col mt-4">
                                <label for="items_value_disc_starts_at" class="d-block p-2 text-center fw-bold form-label">{{__("app.starts_at")}}</label>
                                <input type="date" id="items_value_disc_starts_at" value="<?php echo date("Y-m-d" , strtotime($discount->starts_at)); ?>" class="form-control" name="items_value_disc_starts_at">
                            </div>
                            <div class="col mt-4">
                                <label for="items_value_disc_ends_at" class="d-block p-2 text-center fw-bold form-label">{{__("app.ends_at")}}</label>
                                <input type="date" id="items_value_disc_ends_at" @if($discount->ends_at) value="<?php echo date("Y-m-d" , strtotime($discount->ends_at)); ?>" @endif class="form-control" name="items_value_disc_ends_at">
                            </div>
                        </div>
                    </div>
                </div>
