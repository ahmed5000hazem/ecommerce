...
@section('content')
    ...
    <div class="container my-5 pt-3 pb-5" dir="rtl">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="/admin/discounts/item-value-disc/{{$discount->id}}/delete" method="post">
                            @csrf
        ...
        <form action="/admin/discount/item-value-disc/{{$discount->id}}/update" method="post">
            @csrf
                        ...
                        <div class="col">
                            <div class="card mt-5" style="">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="/admin/product/{{$product->id}}/show" class="btn btn-primary">{{__("app.details")}}</a>
