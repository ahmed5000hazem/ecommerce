...
<div class="container pt-5">
    <h2 class="text-center mb-4">{{__("app.your-orders")}}</h2>
        ...
        <div class="col-md-9">
            <table class="table table-borderless table-hover align-middle">
                <thead class="bg-light rounded border">
                    <tr class="rounded">
                        <th scope="col" class="w-25">{{__("app.created_at")}}</th>
                        <th scope="col" class="w-25"><span class="text-muted">{{__("app.order-status")}}</span></th>
                        <th scope="col" class="w-25"><span class="text-muted">{{__("app.total")}}</span></th>
                        <th scope="col" class="w-25"><span class="text-muted">{{__("app.tools")}}</span></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" onclick="window.location='/order/{{$order->id}}/details'" class="btn btn-info btn-sm text-light"> {{__("app.details")}} </button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
