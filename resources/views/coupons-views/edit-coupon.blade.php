...
@section('content')
    ...
    <div class="container py-5 mt-5">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="/seller/coupons/{{$coupon->id}}/delete" method="post">
                            @csrf
        ...
        @endif
        <form action="/seller/coupons/update/{{$coupon->id}}" method="post">
            @csrf
            <div class="row justify-content-center">
                <div class="col-md-8 col-sm-12">
                    ...
                    <div class="mt-5 pt-3">
                        ...
                        <button type="button" class="float-end btn btn-danger" data-bs-toggle="modal" data-bs-target="#modal{{$coupon->id}}">
                            {{__("app.delete")}}
                        </button>
                    </div>
                </div>
