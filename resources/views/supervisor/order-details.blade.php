                    ...
                    <li class="list-group-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 d-flex align-items-center">
                                <form action="/supervisor/{{$order->id}}/change-order-status" method="post">
                                    @csrf
                        ...
                        @elseif($canceled)
                            <div class="row align-items-center">
                                ...
                                <div class="col-4">
                                    <form action="/supervisor/{{$order->id}}/cancel-order" method="post">
                                        @csrf
                                        <div class="d-grid">
                        ...
                        @elseif($rejected)
                            <div class="row align-items-center">
                                ...
                                <div class="col-4">
                                    <form action="/supervisor/{{$order->id}}/reject-order" method="post">
                                        @csrf
                                        <div class="d-grid">
